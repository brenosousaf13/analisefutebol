...
const MatchesPage: React.FC = () => {
    ...
    return (
        <div className="h-screen overflow-y-auto bg-gray-900 text-white flex flex-col">
            ...
            <div className="pt-24 px-8 pb-8 flex-1">
                <header className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex bg-gray-800 p-1 rounded-lg self-start">
                        <button
                            className={`px-4 py-2 rounded-md font-medium text-sm flex items-center gap-2 transition bg-panel-dark text-white shadow shadow-black/50`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-md font-medium text-sm flex items-center gap-2 transition text-gray-400 hover:text-white hover:bg-gray-700`}
                        >

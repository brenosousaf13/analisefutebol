...
const MyAnalyses = () => {
    ...
    return (
        <div className="min-h-screen bg-dashboard-page flex flex-col">
            <Header />
            <div className="pt-12 lg:pt-20 px-4 md:px-6 lg:px-8 pb-8 max-w-7xl mx-auto w-full flex-1">
                {/* Header */}
                <div className="mb-6 space-y-4">
                    {/* Title row + New Analysis Button */}
                    <div className="flex items-start justify-between gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-gradient-to-r from-[#27D888] to-[#ACFA70] text-[#0D0D0D] hover:shadow-[0_0_20px_rgba(39,216,136,0.3)] px-3 py-2 rounded-lg font-bold transition-all shadow-lg shadow-emerald-900/20 shrink-0 text-sm"
                        >
                    ...
                    <div className="flex items-center gap-2">
                        <select
                            ...
                            className="px-2 py-2 bg-dashboard-card border border-gray-700 rounded-lg text-white focus:border-[#27D888] focus:outline-none shrink-0 text-sm"
                        >
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 bg-dashboard-card border border-gray-700 rounded-lg text-white placeholder-gray-500 w-full focus:border-[#27D888] focus:outline-none text-sm"
                            />
                        </div>
                    </div>
                </div>
                ...
                {/* Filters Row */}
                <div className="flex items-center justify-between mb-6 bg-dashboard-card/50 rounded-xl p-2 gap-2">
                    <div className="flex gap-1 shrink-0">
                        <span className="px-3 py-2 rounded-lg text-sm font-medium bg-green-500 text-white cursor-default">
                            Todas
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none bg-[#242938] border border-gray-700 rounded-lg px-2 py-2 pr-7 text-xs text-gray-300 cursor-pointer"
                            >
